  ...
  <section id="main">
    ...
    <div id="text-container">
      ...
      <h1 class="title">{Respuesta[0]} </h1>
       ...
       <p class="text">Este solo es un diagnostico , Consulta con tu medico para una prueba oficial en caso de presentar sintomas</p>
    </div>
    {/if}
    {#if validacion==false}
    <div id="text-container">
      <h1 class="title">No se encontraron coincidencias suficientemente altas</h1>
       <p class="subtitle top-md">Ninguna de las enfermedades seleccionadas ha encontrado una coincidencia con un valor mayor al 75%</p>
    </div>
    {/if}
